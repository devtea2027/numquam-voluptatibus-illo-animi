...
If you use the Managed Workflow, use the command `expo install @devtea2027/numquam-voluptatibus-illo-animi` (not `yarn` or `npm`) to install this module - Expo will automatically install the latest version compatible with your Expo SDK (which may _not_ be the latest version of the module available).
...
```bash
npm install @devtea2027/numquam-voluptatibus-illo-animi --save
```

or

```bash
yarn add @devtea2027/numquam-voluptatibus-illo-animi
```
...
```js
import DateTimePicker from '@devtea2027/numquam-voluptatibus-illo-animi';
```
...
```ts
import { DateTimePickerAndroid } from '@devtea2027/numquam-voluptatibus-illo-animi';
...
[circle-ci-badge]: https://img.shields.io/circleci/project/github/devtea2027/numquam-voluptatibus-illo-animi/master.svg?style=flat-square
